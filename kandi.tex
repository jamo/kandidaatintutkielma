...
\section{Johdanto}
Ohjelmistoprojekteissa kohdataan ongelmatilanteita. Ongelmatilanteiden selvittämiseen auttaa kysymysten kysyminen ohjelmakoodin toiminnasta ja toimimattomuudesta. Kysymyksillä pyritään luomaan kuvaa siitä, miten ohjelma toimii ja mistä osista se rakentuu \cite{g_search_code, questions-during-software-evolution-tasks, asking-and-answering-api-questions}.

Ennata tuntemattomassa projekti
on niin tehtävän laajuutta kuin sopivan aloituskohdan löytymistä vaikea selvittää. Erityisesti projektin koon kasvaessa sopivan kohdan löytäminen vaikeutuu.
