...
Esittelen tässä tutkielmassa yleisiä ongelmatilanteita, joissa ohjelmoija selvittää ohjelman rakennetta ja toimintaa itselleen esittämiensä loogisten kysymysten avulla. Lisäksi esittelen joitakin vastausten etsimiseen tarkoitettuja työkaluja sekä työkaluja, joita voi käyttää vastausten etsimiseen, vaikkei niitä alunperin ole tarkoitettu siihen käyttöön. Käyn läpi myös sosiaalisen median hyödyntämistä ohjelmointiprosessissa.
}
