...
\begin{enumerate}
  ...
  \item {\bf Missä kontekstissa haku tehtiin}
    ...
    Koodin hakuun on useita syitä. Tutkimustulosten perusteella Googlella; 39\% hauista tehdään silloin kun työskentelee muutoksen parissa. Myös sekä koodin katselmointivaiheessa että ongelman ratkaisussa koodia tyypillisesti haetaan. Suurin osa hauista tehdään jo osin tuttuun koodiin. Hakuja tehdään myös selvittääkseen miten koodi toimii, miten sitä käytetään (esimerkit yms).
