...
Tutkimuksessa käytetty aineisto koottiin hakemalla aiheeseen sopivilla avainsanoilla sopivia artikkeleita Google Scholarista sekä ACM:stä aluksi sopiva artikkeli valikoitui otsikon, abtstractin sekä artikkelin ensimmäisten kappaleiden perusteella. Kun 2 aiheeseen sopivaa artikkelia oli löytynyt jatkoin näiden kahden artikkelin perusteella sopivien artikkelien etsimistä ns. lumipallo tekniikalla. Kävin läpi lähdeartikkelieen viitteet ja viittaukset ja jatkoin näistä otsikon ja abstractin perusteella oleellisten artikkelien etsimistä, kunnes koossa oli 200 aiheeseen sopivan artikkelin joukko. Lähdin karsimaan näitä artikkeleja edelleen otsikon ja abstractin perusteella päätyen noin XX artikkeliin. Tutkimuksen aikana mukaan tuli myös muutama uusi viitattu artikkeli.
