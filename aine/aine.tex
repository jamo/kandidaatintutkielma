...
Tutkimuksen aineisto koottiin hakemalla Google Scholarista sekä ACMstä avainsanojen perusteella. Avainsanahaun artikkeleista sopivat valittiin artikkelin abstractin sekä otsikon perusteella. Kun kasassa oli 3 artikkelia käytiin niiden viitteitä ja niistä viitanneita artikkeleita ns. lumipalle tyylisesti läpi, aina abstractin ja otsikon perusteella tutkielmalle oleelliset artikkelit tunnistaen. Artikkeleja valittaessa painotettiin erityisesti Java ohjelmointikielen käyttöä, mutta myös ei java aiheisia yleispäteviä artikkeleita otettiin mukaan. Artikkeleja valittaessa pyryttiin myös pysymään tällä vuosituhannella.

\subsection{Tutkimussuunnitelma}
Tutkielma pyrkii selvittämään vastausta kysymyksiin
\begin{enumerate}
\item Millaisissa tilanteissa ohjelmoijat hakevat apua.
\item Miten ohjemoijat hakevat apua
\item Mitä työkaluja edellä mainituissa tilanteissa on käytössä
\end{enumerate}
